-- Drop and recreate the 4-parameter version of create_bl_from_bc
DROP FUNCTION IF EXISTS public.create_bl_from_bc(text, text, date, numeric);

CREATE FUNCTION public.create_bl_from_bc(
  p_bc_id TEXT,
  p_bl_id TEXT,
