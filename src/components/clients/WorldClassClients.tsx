...
// ─────────────────────────────────────────────────────
const T = {
  gold: '#D4A843', goldGlow: 'rgba(212,168,67,0.25)', goldBorder: 'rgba(212,168,67,0.3)',
  navy: '#0B1120', cardBg: 'linear-gradient(145deg, #111B2E 0%, #162036 100%)', cardBorder: '#1E2D4A',
  success: '#22C55E', warning: '#F59E0B', danger: '#EF4444', info: '#D4A843', purple: '#9CA3AF',
...
export default function WorldClassClients() {
  ...
  return (
    <div style={{ fontFamily: "ui-monospace, SFMono-Regular, 'SF Mono', Menlo, Consolas, 'Liberation Mono', monospace", background: 'transparent', minHeight: '100vh', color: T.textPri }}>
      <style>{`
