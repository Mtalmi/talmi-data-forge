...
const GOLD    = '#D4A843';
const GOLD_D  = 'rgba(212,168,67,0.12)';
const GREEN   = '#22C55E';
...
const BLUE    = '#D4A843';
const BLUE_D  = 'rgba(212,168,67,0.12)';
const GRAY    = '#94A3B8';
const GRAY_D  = 'rgba(148,163,184,0.12)';
const PURPLE  = '#9CA3AF';
const PURPLE_D= 'rgba(156,163,175,0.12)';
const CYAN    = '#6B7280';
const CYAN_D  = 'rgba(107,114,128,0.12)';
const PINK    = '#EF4444';
const TEXT1   = '#F1F5F9';
const TEXT2   = '#94A3B8';
const TEXT3   = '#64748B';
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 14 }}>
        ...
        {trend && <span style={{ fontSize: 12, fontWeight: 500, color: trendColor || '#9CA3AF' }}>{trend}</span>}
      </div>
      <div style={{ fontFamily: "ui-monospace, SFMono-Regular, 'SF Mono', Menlo, monospace", fontSize: 36, fontWeight: 700, color: '#fff', lineHeight: 1, letterSpacing: '-0.02em' }}>{value}</div>
