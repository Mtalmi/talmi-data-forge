    ...
    <div className="overflow-x-hidden max-w-full w-full" style={{ fontFamily: 'Inter, system-ui, sans-serif', color: T.textPri }}>
      ...
      <div style={{ maxWidth: '100%', margin: '0 auto' }} className="relative overflow-hidden">
        ...
        <div className="tbos-grid-3col grid grid-cols-1 lg:grid-cols-3 gap-4 mb-5 relative z-[1] w-full" style={{ alignItems: 'start', borderRadius: 0, overflow: 'visible' }}>
          ...
          {!hideProductionWidgets && (
          <Card className="ops-enter ops-surface-card tbos-stagger-6 lg:col-span-3" style={{ borderRadius: 8, padding: 20, border: '1px solid rgba(245, 158, 11, 0.15)', background: 'linear-gradient(to bottom right, #1a1f2e, #141824)', position: 'relative', overflow: 'hidden' }}>
            <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: '2px', background: 'linear-gradient(90deg, transparent 0%, rgba(212,168,67,0.7) 50%, transparent 100%)', zIndex: 99, pointerEvents: 'none' }} />
        ...
        {!hideOpsWidgets && (
        {!alertBarDismissed && (
          <div style={{ background: 'linear-gradient(135deg, rgba(212,168,67,0.08) 0%, rgba(212,168,67,0.02) 100%)', border: '1px solid rgba(212,168,67,0.25)', borderLeft: '3px solid #D4A843', borderRadius: '8px', padding: '10px 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '12px', opacity: alertBarDismissed ? 0 : 1, transition: 'opacity 300ms' }} className="mb-4 relative z-[1] w-full">
