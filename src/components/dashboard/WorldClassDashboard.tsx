  ...
  return (
    <div className="overflow-x-hidden max-w-full w-full" style={{ fontFamily: 'Inter, system-ui, sans-serif', color: T.textPri }}>
      ...
      <div style={{ maxWidth: '100%', margin: '0 auto' }} className="relative overflow-hidden">
        ...
        {!hideOpsWidgets && (
          <div style={{ background: 'linear-gradient(to right, rgba(212,168,67,0.08), rgba(212,168,67,0.02), transparent)', border: '1px solid rgba(212,168,67,0.25)', borderRadius: '8px', padding: '10px 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '12px' }} className="mb-4 relative z-[1] w-full">
