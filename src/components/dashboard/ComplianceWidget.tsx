...
export function ComplianceWidget() {
  ...
  return (
    ...
    >
      <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: '3px', background: 'linear-gradient(90deg, transparent, rgba(34,197,94,0.7), transparent)', zIndex: 99, pointerEvents: 'none' }} />
      {/* Label */}
