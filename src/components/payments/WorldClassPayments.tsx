...
function KPICard({ label, value, suffix, color, icon: Icon, trend, trendPositive = true, delay = 0 }: {
  ...
  return (
    <div style={{ borderTop: '4px solid #FFD700', borderRadius: 8, opacity: visible ? 1 : 0, transform: visible ? 'translateY(0)' : 'translateY(20px)', transition: 'all 600ms ease-out' }}>
      <Card style={{ borderTop: 'none', borderRadius: '0px 0px 8px 8px', background: 'linear-gradient(145deg, rgba(255,215,0,0.04) 0%, #111B2E 40%, #162036 100%)' }}>
...
export default function WorldClassPayments() {
  ...
  return (
    <div style={{ fontFamily: "ui-monospace, SFMono-Regular, 'SF Mono', Menlo, Consolas, 'Liberation Mono', monospace", background: T.navy, minHeight: '100vh', color: T.textPri }}>
      ...
      {/* CONTENT */}
      <div style={{ width: '100%', padding: '32px 24px', display: 'flex', flexDirection: 'column', gap: 44 }}>
