...
function KPICard({ label, value, suffix, color, icon: Icon, trend, delay }: {
  ...
  return (
    ...
    >
      ...
      <div>
         <div>
           <span style={{ fontFamily: 'ui-monospace, SFMono-Regular, SF Mono, Menlo, monospace', fontWeight: 100, fontSize: '48px', letterSpacing: '-0.02em' }}>{count.toLocaleString('fr-FR')}</span>{suffix && <span style={{ fontSize: 20, fontWeight: 400, color: '#9CA3AF', marginLeft: 4 }}>{suffix}</span>}
         </div>
