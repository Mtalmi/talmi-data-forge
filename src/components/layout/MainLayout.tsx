...
export default function MainLayout({ children, hideBottomNav = false }: MainLayoutProps) {
  ...
  return (
    <div className="relative min-h-[100dvh] bg-background flex w-full">
      ...
      <div className={`relative z-10 flex flex-col min-h-[100dvh] flex-1 overflow-x-hidden max-w-full transition-[margin] duration-300 ${sidebarOpen ? 'lg:ml-[220px]' : 'lg:ml-0'}`}>
        {/* Preview Mode Banner */}
        {previewRole && (
          <RolePreviewBanner
