            ...
            <CardContent className="p-4">
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="font-semibold text-lg text-amber-500">{outstanding.toLocaleString('fr-MA')} DH</p>
                </div>
              </div>
              ...
              <ScrollArea className="h-[300px]">
                <div className="p-4 space-y-2">
                  {payments.map((payment, index) => {
                    ...
                    const daysLate = status === 'overdue' 
                      ? differenceInDays(today, new Date(payment.due_date))
                      : 0;
                      ...
                      >
                        ...
                        <div className="text-right">
                          <p className="font-semibold">
                            {Number(payment.scheduled_amount).toLocaleString('fr-MA')} DH
                          </p>
                          {status === 'paid' && payment.paid_date && (
