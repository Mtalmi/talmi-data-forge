...
export default function DimensionRadarChart() {
  return (
    <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6" role="img" aria-label={`Radar des scores par dimension : ${DIMENSION_SCORES.map(d => `${d.dimension} ${d.score}/10`).join(', ')}`}>
