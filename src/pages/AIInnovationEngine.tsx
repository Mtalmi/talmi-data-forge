      ...
      <div className="lg:col-span-5 space-y-4">
        ...
        <Card className="border-primary/20 bg-primary/5">
          <CardContent className="p-4">
            ...
            <div className="text-2xl font-extralight text-primary">{ideas.length > 0 ? Math.round(ideas.reduce((a, i) => a + i.score, 0) / ideas.length) : '--'}<span className="text-sm text-muted-foreground">/100</span></div>
