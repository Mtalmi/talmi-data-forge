    ...
    <MainLayout>
      ...
      >
        ...
        <div className="relative" ref={heroRef}>
          ...
          <div className="mt-5 gap-3" style={{ background: 'linear-gradient(to right, rgba(212,168,67,0.06), rgba(212,168,67,0.02), transparent)', border: '1px solid rgba(212,168,67,0.12)', borderRadius: '8px', padding: '10px 20px', margin: '0 0 8px 0', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
