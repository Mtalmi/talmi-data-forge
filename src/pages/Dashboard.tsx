    ...
    <MainLayout>
      ...
      >
            ...
            {bellOpen && (
              ...
              >
                ...
                <div
                  ...
                  onClick={() => setBellOpen(false)}
                >
                  <span className="h-2.5 w-2.5 rounded-full bg-warning mt-1.5 flex-shrink-0" />
                  <div className="flex-1 min-w-0">
                ...
                <div
                  ...
                  onClick={() => setBellOpen(false)}
                >
                  <span className="h-2.5 w-2.5 rounded-full bg-success mt-1.5 flex-shrink-0" />
                  <div className="flex-1 min-w-0">
        ...
        <div className="relative" ref={heroRef}>
          ...
          <div className="relative z-[1] border-b border-white/[0.04] pb-4 mb-2" style={{ animation: 'fadeSlideIn 0.7s cubic-bezier(0.16,1,0.3,1) 0.1s both', padding: '24px 0 16px' }}>
            <div className="flex items-center justify-center gap-4">
              ...
              <div className="flex flex-col items-start">
                {/* Title row */}
                <div aria-hidden="true" style={{ fontFamily: "'Inter', 'DM Sans', sans-serif", lineHeight: 1.1, fontSize: 28 }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 mt-5 relative z-[1] items-stretch">
        ...
        <div className="mt-8 mb-6 px-4 flex items-center justify-between" style={{ fontFamily: "ui-monospace, 'JetBrains Mono', monospace", fontSize: 11, color: 'rgba(148,163,184,0.15)' }}>
          <span>TBOS {activeTab === 'command' ? 'COMMAND CENTER' : activeTab === 'production' ? 'PRODUCTION LIVE' : activeTab === 'operations' ? 'OPÉRATIONS' : 'INTELLIGENCE IA'} v2.0 — {new Date().toLocaleDateString('fr-FR', { day: '2-digit', month: '2-digit', year: 'numeric', timeZone: 'Africa/Casablanca' })}</span>
