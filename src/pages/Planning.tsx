...
export default function Planning() {
  ...
  const getStatusBadge = (status: string) => {
    ...
    return <Badge className={cn("font-medium text-[10px] border-0 whitespace-nowrap", config.className)}>{config.label}</Badge>;
  };
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <Input
                ...
                onBlur={commitTime}
                className={cn("text-sm bg-white/[0.02] border-white/[0.08] text-foreground", isTouchDevice ? "h-11 text-base" : "h-8")}
              />
            </div>
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                >
                  <SelectTrigger className={cn("text-sm bg-white/[0.02] border-white/[0.08] text-foreground", isTouchDevice ? "h-11 text-base" : "h-8")}>
  ...
  return (
    <MainLayout>
      ...
      <div className="space-y-6 transition-all duration-300" style={{ maxWidth: 1400, margin: '0 auto', padding: '24px 24px', paddingRight: fleetPanelOpen && !isMobile ? 'calc(24px + 272px)' : '24px', transition: 'padding-right 300ms ease-in-out' }}>
        {isReadOnly && (
